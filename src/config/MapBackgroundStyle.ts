...
export const getMapStyle = ({
	...
	isProjectPage,
	currentPath,
}: MapStyleParams): StyleSpecification => ({
	version: 8,
	...
	layers: [
		...
		},
		{
			...
			paint: {
				...
				"fill-opacity": currentPath === "/rma-android" ? 1 : 0,
				"fill-opacity-transition": standardPaintTransition,
			},
		},
		{
			...
			paint: {
				...
				"line-opacity":
					currentPath === "/rma-android"
						? ["interpolate", ["exponential", 1], ["zoom"], 14.8, 0.75, 14.9, 1]
						: 0,
				"line-opacity-transition": standardPaintTransition,
			},
		},
		...
		},
		{
			...
			paint: {
				...
				"fill-opacity":
					currentPath === "/rma-android"
						? ["interpolate", ["exponential", 1], ["zoom"], 14, 0.75, 15, 0.5]
						: 0,
